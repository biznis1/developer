...
$to="pk21395@gmail.com";
$sub="Feedback of Lucky 7 game.";
$header="From: $sid $sid1 $sid2<$sid3>";
//for fbyes 
if(isset($fbyes))
{
	$message="Thanks, Nice game";
...
if(isset($fbno))
{
	$mess="I don't like the game.";
	mail($to,$sub,$mess,$header);
	echo "<script>alert('Thanks for feedback.');</script>";
}
?>
<!DOCTYPE html>
...
<link rel="stylesheet" href="css files/mystyle1.css">
...
<div class="collapse navbar-collapse" id="mynavs">
	...
	<li class="active"><a style="color:white">Welcome : <span class="glyphicon glyphicon-user"><span>&nbsp<?php echo $sid.' '.$sid2;?></a></li>
