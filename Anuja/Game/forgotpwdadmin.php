...
<div class="container-fluid">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<form class="form-horizontal" method="POST" name="fdbk" style="padding-left:20px;padding-right:20px">
							...
							<div class="form-group">
							 <input type="tel" name="otp" id="otp" class="form-control" required="required" placeholder="OTP">
                                                        ...
                                                        <div class="form-group">
							 <input type="hidden" name="otpp" id="otpp" class="form-control" required="required" placeholder="OTP">
							</div>
                                                        <div class="form-group">
