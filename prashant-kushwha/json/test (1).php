<?php
    ...
    function cdnraDecode($ir)
	{
		...
		$rar['cdnra'][]=array('flag'=>$ir['flag'], 'updby'=>$ir['updby'],'chksum'=>$ir['chksum'], 'ntty'=>$ir['ntty'],  'rsn'=>$ir['rsn'], 'ont_num'=>$ir['ont_num'], 'ont_dt'=>$ir['ont_dt'], 'nt_num'=>$ir['nt_num'], 'nt_dt'=>$ir['nt_dt'], 'inum'=>$ir['inum'], 'idt'=>$ir['idt'], 'rchrg'=>$ir['rchrg'], 'val'=>$ir['val'], 'irt'=>$ir['irt'], 'iamt'=>$ir['iamt'], 'crt'=>$ir['crt'], 'camt'=>$ir['camt'], 'srt'=>$ir['srt'], 'samt'=>$ir['samt'], 'csrt'=>$ir['csrt'], 'csamt'=>$ir['csamt'], 'etin'=>$ir['etin']);
        return $rar;
