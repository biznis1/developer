...
function esociety(){
             ...
             $("#enter_society").hide();
            $("#enter_notice").html("<div class='row'><div class='col s12 m12'><div class='card amber lighten-4'><div class='card-content modal-content black-text'><p><b>Entry Exist:</b><br>Ask the Society Gaurd to enter in the society</p></div></div></div></div>");
