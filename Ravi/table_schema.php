 ...
 */
	...
	*/
    ...
    {
		$rar['b2b']=array('ctin'=>$ir[0]['ctin'], 'cfs'=>$ir[0]['cfs']);
        $rar['b2b']['invoice']=array('chksum'=>$ir[0]['inv'][0]['chksum'], 'updby'=>$ir[0]['inv'][0]['updby'], 'inum'=>$ir[0]['inv'][0]['inum'], 'idt'=>$ir[0]['inv'][0]['idt'], 'val'=>$ir[0]['inv'][0]['val'], 'pos'=>$ir[0]['inv'][0]['pos'], 'rchrg'=>$ir[0]['inv'][0]['rchrg'], 'etin'=>$ir[0]['inv'][0]['etin'], 'inv_typ'=>$ir[0]['inv'][0]['inv_typ'], 'cflag'=>$ir[0]['inv'][0]['cflag']);
